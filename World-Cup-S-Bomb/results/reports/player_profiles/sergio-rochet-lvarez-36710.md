# Sergio Rochet Álvarez — Qatar 2022 Goalkeeper Profile
...
- Goalkeeper rank: 19
- Consolidated Goalkeeper Value: 0.0718
- Raw consolidated value: 0.0263
- 95% score interval: 0.0666 to 0.3479
- Bootstrap rank interval: 13 to 27

## Evidence channels

| Channel | Value |
|---|---:|
| PSxG shot-stopping | -0.0025 |
| Clutch-save residual | 0.0083 |
| Regular-penalty impact | 0.1523 |
| Shootout win probability added | 0.0000 |
| Support value | 0.0169 |
| Expected threat faced per 90 | 0.2912 |
