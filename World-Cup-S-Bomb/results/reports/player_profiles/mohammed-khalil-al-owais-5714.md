# Mohammed Khalil Al Owais — Qatar 2022 Goalkeeper Profile
...
- Goalkeeper rank: 11
- Consolidated Goalkeeper Value: 0.1934
- Raw consolidated value: 0.0493
- 95% score interval: 0.0879 to 0.5753
- Bootstrap rank interval: 5 to 23

## Evidence channels

| Channel | Value |
|---|---:|
| PSxG shot-stopping | 0.0581 |
| Clutch-save residual | 0.1698 |
| Regular-penalty impact | -0.0939 |
| Shootout win probability added | 0.0000 |
| Support value | 0.0625 |
| Expected threat faced per 90 | 1.6597 |
