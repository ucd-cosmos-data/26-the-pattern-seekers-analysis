# Devis Rogers Epassy Mboka — Qatar 2022 Goalkeeper Profile
...
- Goalkeeper rank: 13
- Consolidated Goalkeeper Value: 0.1416
- Raw consolidated value: 0.0395
- 95% score interval: 0.1103 to 0.4367
- Bootstrap rank interval: 9 to 19

## Evidence channels

| Channel | Value |
|---|---:|
| PSxG shot-stopping | 0.0405 |
| Clutch-save residual | 0.1018 |
| Regular-penalty impact | 0.0000 |
| Shootout win probability added | 0.0000 |
| Support value | 0.0087 |
| Expected threat faced per 90 | 2.5480 |
