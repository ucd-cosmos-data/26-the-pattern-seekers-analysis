# Meshaal Aissa Barsham — Qatar 2022 Goalkeeper Profile
...
- Goalkeeper rank: 23
- Consolidated Goalkeeper Value: 0.0440
- Raw consolidated value: 0.0179
- 95% score interval: 0.0581 to 0.2680
- Bootstrap rank interval: 19 to 26

## Evidence channels

| Channel | Value |
|---|---:|
| PSxG shot-stopping | -0.0467 |
| Clutch-save residual | 0.0000 |
| Regular-penalty impact | -0.0604 |
| Shootout win probability added | 0.0000 |
| Support value | 0.0260 |
| Reliability | 0.2992 |
