# Francisco Guillermo Ochoa Magaña — Qatar 2022 Goalkeeper Profile
...
- Goalkeeper rank: 27
- Consolidated Goalkeeper Value: 0.0294
- Raw consolidated value: 0.0183
- 95% score interval: 0.0303 to 0.3002
- Bootstrap rank interval: 14 to 30

## Evidence channels

| Channel | Value |
|---|---:|
| PSxG shot-stopping | -0.0288 |
| Clutch-save residual | 0.0151 |
| Regular-penalty impact | 0.0745 |
| Shootout win probability added | 0.0000 |
| Support value | -0.1174 |
| Expected threat faced per 90 | 0.4025 |
