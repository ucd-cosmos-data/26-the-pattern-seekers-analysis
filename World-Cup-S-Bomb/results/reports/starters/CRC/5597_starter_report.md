# Keylor Navas Gamboa — Qatar 2022 Goalkeeper Profile
...
- Goalkeeper rank: 28
- Consolidated Goalkeeper Value: 0.0239
- Raw consolidated value: 0.0140
- 95% score interval: 0.0000 to 0.4872
- Bootstrap rank interval: 7 to 32

## Evidence channels

| Channel | Value |
|---|---:|
| PSxG shot-stopping | -0.1020 |
| Clutch-save residual | 0.1320 |
| Regular-penalty impact | -0.0926 |
| Shootout win probability added | 0.0000 |
| Support value | -0.0170 |
| Reliability | 0.3955 |
